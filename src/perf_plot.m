...
h = title(sprintf('$%d \\times %d$ channel, $%d$ taps, $W\\tau = %0.1f$. $\\epsilon_r = 10^{%d}$, $\\mu = 10^{%d}$', ...
    rows,cols,lags,WTau,log10(eps_r),log10(mu))); set(h,'FontSize',text_size);
